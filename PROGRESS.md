...
| | |
|---|---|
| **Last updated** | 2026-08-15 (S3M.2 — **D38 CLOSED as an OBSERVABILITY defect**: output-budget exhaustion is now a first-class body-free metric, and deliberately **not** a gate. 0 generations, 0 authorities, no candidate 003) |
...
| Scope | Result | When |
|---|---|---|
| **Focused M62 (`-k m62`, `--ignore=tests/test_live_brain_v61.py`)** | **3015 passed, 18 skipped, 0 failed** (2m15s) | **S3M.2, 2026-08-15, KALI (system interpreter) — AUTHORITATIVE for M62 on this interpreter.** Reconciles exactly: S3M.1's 2951 + the 64 new S3M.2 tests |
