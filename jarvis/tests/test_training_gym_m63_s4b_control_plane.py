...
def test_the_project_block_did_not_move_master_or_merge():
    ...
    # V69 M65D — D57, the same defect in a fifth place. S5G's rescoping argued the
    ...
    assert V._is_ancestor(project["master_commit"], base), (
        f"integration_base {base[:12]} is behind the historically integrated master; "
        f"the authorisation rewound")
